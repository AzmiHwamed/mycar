...
public class CarsListAdapterfollow extends ArrayAdapter<Appoin>{

    // invoke the suitable constructor of the ArrayAdapter class
    public CarsListAdapterfollow(@NonNull Context context, ArrayList<Appoin> arrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        currentItemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i =new Intent(getContext(),ApointemetDetails.class);
                i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                i.putExtra("date",currentNumberPosition.getDate());
                i.putExtra("immat",currentNumberPosition.getImmat());
                i.putExtra("shop",currentNumberPosition.getShop());
                i.putExtra("type",currentNumberPosition.getType());
