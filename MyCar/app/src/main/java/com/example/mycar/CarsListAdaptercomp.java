...
public class CarsListAdaptercomp extends ArrayAdapter<Appoin>{

    // invoke the suitable constructor of the ArrayAdapter class
    public CarsListAdaptercomp(@NonNull Context context, ArrayList<Appoin> arrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        currentItemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i =new Intent(getContext(),Complaint2.class);
